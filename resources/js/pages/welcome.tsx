...
export default function Welcome() {
    ...
    return (
        <div className="bg-neutral-100 px-12">
            <section className="flex h-screen overflow-hidden bg-neutral-100">
                <div className="relative flex flex-1 items-center">
                    <div className="absolute top-16 left-0 font-noto-jp text-xl font-semibold">
                    ...
                    <div className="absolute bottom-12 left-0 text-xl font-semibold">
                        <div className="flex gap-2">
                            <span>タ</span>
                            <span>ス</span>
                            <span>ク</span>
                ...
                <div className="relative flex-1">
                    <div className="absolute top-16 right-0 font-noto-jp text-xl font-semibold">
